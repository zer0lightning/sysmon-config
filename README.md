...
Added Living Off The Land Drivers [LolDrivers](https://github.com/magicsword-io/LOLDrivers/blob/main/detections/sysmon/sysmon_config_vulnerable_hashes_block.xml) to a new config file - [sysmonconfig-export-block-with-vulndrivers.xml](https://github.com/zer0lightning/sysmon-config/blob/master/sysmonconfig-export-block-with-vulndrivers.xml)
